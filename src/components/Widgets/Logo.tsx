  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: 9, userSelect: 'none' }}>
      ...
      <svg width={size} height={size} viewBox="0 0 64 64" style={{ flexShrink: 0 }}>
        ...
        {/* Handle — wood barrel */}
        <rect x="27" y="36" width="10" height="22" rx="4" fill="url(#lg1)" opacity="0.9" filter="url(#glow)"/>
        {/* Handle highlight */}
        <rect x="30" y="38" width="2" height="18" rx="1" fill="#fff" opacity="0.15"/>

        {/* Ferrule (metal band connecting handle to bristles) */}
        ...
        {/* Bristles — fanning outward from ferrule */}
        <path
          ...
          fill="url(#lg1)" opacity="0.85" filter="url(#glow)"
        />

        {/* Ink drop falling from bristle tip */}
